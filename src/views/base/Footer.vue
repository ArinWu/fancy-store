...
.footerHomeIcon {
   background: url('../../../public/img/icon/footer_sprites.png') -10px -10px;
}

.footerCategoryIcon {
  background: url('../../../public/img/icon/footer_sprites.png') -10px -146px;
}

.footerCartIcon {
  background: url('../../../public/img/icon/footer_sprites.png') -10px -282px;
}

.footerMemberIcon {
  background: url('../../../public/img/icon/footer_sprites.png') -10px -418px;
}
...
.active .footerHomeIcon {
  background: url('../../../public/img/icon/footer_sprites.png') -10px -78px;
}

.active .footerCategoryIcon {
  background: url('../../../public/img/icon/footer_sprites.png') -10px -214px;
}

.active .footerCartIcon {
  background: url('../../../public/img/icon/footer_sprites.png') -10px -350px;
}

.active .footerMemberIcon {
  background: url('../../../public/img/icon/footer_sprites.png') -10px -486px;
}
</style>
