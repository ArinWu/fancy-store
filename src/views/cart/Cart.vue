...
.cart_radio{
    background: url('../../../public/img/icon/common_sprites.png') -10px -114px;

  }
  .cart_radio_select{
    background: url('../../../public/img/icon/common_sprites.png') -10px -10px;
...
.goodsOp {
  ...
  input {
   ...
   .shop_cut{
    ...
    background: url('../../../public/img/icon/common_sprites.png') -10px -574px;
  }
  .shop_add{
    background: url('../../../public/img/icon/common_sprites.png') -10px -642px;
  }
}
